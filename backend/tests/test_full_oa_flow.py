...
"""
    ...
    print(f"Correctness Score: {evaluation['correctness_score']}/100")
    print(f"Code Quality Score: {evaluation['code_quality_score']}/100")
    print(f"Complexity Score: {evaluation['complexity_score']}/100")
    print(f"Test Pass Rate: {evaluation['test_pass_rate']}%")
